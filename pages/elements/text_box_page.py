...
from locators.elements.text_box_page_locators import TextBoxPageLocators
...
class TextBoxPage(BasePage):
    ...
    @allure.step('Fill all fields with generated person data')
    def fill_all_fields(self) -> Tuple[str, str, str, str]:
        ...
        with allure.step('Fill personal data fields'):
    ...
    @allure.step('Check filled form fields')
