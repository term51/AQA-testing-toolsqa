...
class DatePickerPage(BasePage):
    ...
    def select_date(self):
        ...
        self.set_date_by_test(self.locators.DATE_SELECT_MONTH, date.month)
        self.set_date_by_test(self.locators.DATE_SELECT_YEAR, date.year)
        self.set_date_item_from_list(self.locators.DATE_SELECT_DAY_LIST, date.day)

        value_date_after = input_date.get_attribute('value')
        return value_date_before, value_date_after

    def set_date_by_test(self, locator, value):
        select = Select(self.element_is_present(locator))
        select.select_by_visible_text(value)

    def set_date_item_from_list(self, locator, value):
    ...
    def select_datetime(self):
        ...
        self.set_date_item_from_list(self.locators.DATETIME_SELECT_YEAR_LIST, '2020')

        self.set_date_item_from_list(self.locators.DATETIME_SELECT_DAY_LIST, date.day)
